...
public class ListaEquipos {
    ...
    public ListaEquipos(List<Equipo> equipos, String equiposCSV, String connectionDB) {
    ...
    public ListaEquipos() {
        ...
        this.equiposCSV = System.getProperty("user.dir")+"/src/main/java/com/grupo1/tpentrega3/equipos.csv";
